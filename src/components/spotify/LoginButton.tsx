  ...
  return (
    <div className={className}>
      <Link href="/api/auth/spotify/login">
        <a className="flex items-center justify-center gap-2 rounded-lg bg-spotify-brand px-4 py-3 font-medium text-white no-underline shadow-lg shadow-green-200 ring-spotify-brand ring-opacity-40 transition-shadow hover:bg-green-600 focus:outline-none focus:ring-4">
