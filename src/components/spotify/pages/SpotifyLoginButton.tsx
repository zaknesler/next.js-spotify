  ...
  return (
    <div className={className}>
      <Link href="/api/auth/spotify/login">
        <a className="flex items-center justify-center gap-2 rounded-lg bg-[#1db954] px-4 py-3 font-medium text-white no-underline shadow-sm hover:bg-green-600 sm:inline-flex">
